...
app.listen(PORT, () => {
    ...
    📁 Uploads: ./uploads/
    - Subir video: POST /api/admin/upload/video
    - Subir PDF: POST /api/admin/upload/pdf
    - Subir portada de video: POST /api/admin/upload/video-cover
    - Subir portada de PDF: POST /api/admin/upload/pdf-cover
    ═══════════════════════════════════════════════════════
    `);
});
